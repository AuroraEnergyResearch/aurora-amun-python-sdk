...
- `windType` _WindType_ - All flows must provide a unique wind type as defined by the Amun http API.
...
- `reanalysisScaleCorrectionVersion` _int, optional_ - The version of the reanalysis scale correction to use if known.
  Defaults to None.
